...
spectral ratio $\href{\urlpfx/KrafftSieve/OptimalWeights.lean#L182}{\mu_{min}(n)}$. The culminating structure,
\href{\urlpfx/KrafftSieve/OptimalWeights.lean#L693}{\texttt{krafft\_sieve\_guarantee\_with\_mu\_min}},
establishes a strictly finite-dimensional conditional theorem: assuming the analytic bound
$\mu_{min}(n) < 1$ holds, twin primes must fundamentally exist within $\mathcal{A}_n$.
...
\textit{Dirac Comb} structure. Lean 4 rigorously verifies this
(\href{\urlpfx/KrafftSieve/ThirdHarmonic.lean#L438}{\texttt{dirac\_comb\_zero}} and
...
topological deductions. First, Lean 4 guarantees that this finite-dimensional bounded subspace acts
as a compact domain (\href{\urlpfx/KrafftSieve/OptimalWeights.lean#L459}
...
realizing the minimum ratio $\mu_{min}(n)$. Lean formally
