...
verifying that for sufficiently large $n$, \textit{every} Krafft interval independently generates
at least one survivor $x$ such that either $6x-1$ or $6x+1$ is prime.
